    ...
    return (
        <>
            <motion.div
                ...
                className={cn(
                    "absolute left-0 top-20 m-auto h-24 w-px rounded-full bg-gradient-to-t from-indigo-500 via-purple-500 to-transparent",
...
const Explosion: React.FC<ExplosionProps> = ({ className, ...props }) => {
